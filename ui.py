...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.doubleSpinBox_6 = QtWidgets.QDoubleSpinBox(parent=self.groupBox_8)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBox_6, 12, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBox_5, 11, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinBox_6, 13, 2, 1, 1)
        self.doubleSpinBox_7 = QtWidgets.QDoubleSpinBox(parent=self.groupBox_8)
        self.doubleSpinBox_7.setMaximum(100.0)
        self.doubleSpinBox_7.setSingleStep(0.1)
        self.doubleSpinBox_7.setObjectName("doubleSpinBox_7")
        self.gridLayout_2.addWidget(self.doubleSpinBox_7, 14, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinBox_7, 10, 2, 1, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1597, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_14.setText(_translate("MainWindow", "Предел застоя:"))
        ...
        self.label_13.setText(_translate("MainWindow", "Доля элиты:"))
        self.label_4.setText(_translate("MainWindow", "Отклонение в σ: "))
        self.label_8.setText(_translate("MainWindow", "Размер популяции:"))
        self.label_15.setText(_translate("MainWindow", "Порог застоя:"))
        self.label_16.setText(_translate("MainWindow", "Размер потомства:"))
        self.pushButton_7.setText(_translate("MainWindow", "Сбросить параметры"))
        self.pushButton_8.setText(_translate("MainWindow", "Сохранить параметры в файл"))
        ...
        self.pushButton_4.setText(_translate("MainWindow", "К последнему шагу"))
        self.pushButton_3.setText(_translate("MainWindow", "К первому шагу"))
        self.pushButton_9.setText(_translate("MainWindow", "Завершить работу алгоритма"))
        self.groupBox_4.setTitle(_translate("MainWindow", "График приспособленности"))
        self.pushButton_11.setText(_translate("MainWindow", "Сохранить визуализацию"))
        self.pushButton_10.setText(_translate("MainWindow", "Сохранить график"))
